...
- Value $\approx +1$: +ve autocorrelation (clustering)
...
::: {.column width="20%"}
- Massive difference in top 3 kampongs than the rest
- On kampong-level, pop. in Belait, TuTong stands out! 
:::
